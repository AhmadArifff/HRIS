    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center p-6">
          <div className="bg-red-50 border border-red-200 rounded-2xl p-8 max-w-lg w-full text-center space-y-4">
            ...
            <p className="text-gray-600">
              Maaf, ada masalah saat memuat halaman ini. Silakan muat ulang atau kembali ke halaman utama.
            </p>
