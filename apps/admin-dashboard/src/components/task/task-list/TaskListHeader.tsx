...
export type FilterTab = "all" | "todo" | "in-progress" | "completed";
...
export const TaskListHeader: React.FC<TaskListHeaderProps> = ({
  ...
  const [newTaskCategory, setNewTaskCategory] = useState<"Todo" | "In-Progress" | "Completed">("Todo");
      ...
      <div className="border-b border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={() => alert("Filter & Short options clicked.")}
